    ...
    <div className="max-w-3xl w-full p-4 rounded-lg shadow-md">
      <section>
        ...
        <div className="flex mt-4">
          <div
            className={`rounded-full border-2 border-red-500 mr-4 flex justify-center items-center p-1 w-56 ${isActive ? "bg-red-500" : "border-red-500"}`}
            onClick={handleGlobalButtonClick}
          >
            <span className="text-white text-base">Opsi Top 10 Global</span>
          </div>
          <div
            className={`rounded-full border-2 border-red-500 flex justify-center items-center p-1 w-56 ${isActive ? "border-red-500" : "bg-red-500"}`}
